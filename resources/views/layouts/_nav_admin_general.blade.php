...
<li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-shield-check"></i> Roles</a></li>
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="#"><i class="bi bi-calendar-event"></i> Calendario</a></li>
        <li><a class="dropdown-item" href="#"><i class="bi bi-card-list"></i> Tipos de Licencia</a></li>
    </ul>
</li>
<li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-journal-text"></i> Logs</a></li>
